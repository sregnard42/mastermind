...
void imp(char c) {
  textcolor(7);
  switch (c) {
     case 'R' : textcolor(12);break;    // LIGHTRED
     case 'V' : textcolor(10); break;   // LGHTGREEN
     case 'J' : textcolor(14); break;   // YELLOW
     case 'M' : textcolor(13); break;   // LIGHTMAGENTA
     case 'B' : textcolor(9); break;    // LIGHTBLUE
     case 'C' : textcolor(11); break;   // LIGHTCYAN
  }
  cout << c << " ";
  textcolor(7);
}
